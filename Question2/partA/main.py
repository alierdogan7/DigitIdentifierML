...
def main(args):
    ...
    linear_svm_training(dataset)
    linear_svm_testing(dataset, best_C=0.01)


def linear_svm_training(dataset):
...
def linear_svm_testing(dataset, best_C=0.01):
    # lin_svm = svm.LinearSVC(C=0.01)
    lin_svm = svm.SVC(C=best_C, kernel='linear')
